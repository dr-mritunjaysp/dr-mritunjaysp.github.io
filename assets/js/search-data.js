...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Academic CV of Dr. Mritunjay Shall Peelam, Assistant Professor (Selection Grade) at UPES Dehradun.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Teaching",
          description: "Education, courses, and learning resources guided by Dr. Mritunjay Shall Peelam.",
          section: "Navigation",
          handler: () => {
        ...
        },{id: "dropdown-awards-amp-fdp",
              title: "Awards &amp; FDP",
              description: "",
              section: "Dropdown",
              handler: () => {
                window.location.href = "/award-fdp/";
              },
            },{id: "dropdown-game",
              title: "Game",
              description: "",
        ...
        description: "Career update from my academic profile",
        section: "Posts",
        handler: () => {
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/slow-mornings-in-the-hills/";
          
        },
      },{id: "post-completed-fdp-from-iit-guwahati",
        
          title: "Completed FDP from IIT Guwahati",
        
        description: "Faculty development update",
        section: "Posts",
        handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-recognized-among-top-10-most-cited-papers-in-iet-quantum-communication",
          title: '🔥 Recognized among Top 10 Most-Cited Papers in IET Quantum Communication.',
          description: "",
          section: "News",},{id: "news-received-outstanding-research-article-award-at-bits-pilani-doctoral-colloquium-for-work-on-intelligent-transportation-systems",
          title: '🏆 Received Outstanding Research Article Award at BITS Pilani Doctoral Colloquium for work...',
          description: "",
          section: "News",},{id: "news-ph-d-defense",
          title: 'Ph.D. Defense',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_2/";
            },},{id: "news-post-doctoral-fellowship-offer-iit-bhu",
          title: 'Post-Doctoral Fellowship Offer (IIT BHU)',
          description: "",
          section: "News",handler: () => {
          ...
          section: "Teachings",handler: () => {
              window.location.href = "/teaching/computer-organization/";
          ...
          section: "Teachings",handler: () => {
              window.location.href = "/teaching/data-structures/";
          ...
          section: "Teachings",handler: () => {
              window.location.href = "/teaching/software-engineering/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Dr-Mritunjay_resume.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%72%69%74%75%6E%6A%61%79.%70%65%65%6C%61%6D@%64%64%6E.%75%70%65%73.%61%63.%69%6E", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=MdGRPEIAAAAJ", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-8022-3815", "_blank");
        },
      },{
        id: 'social-whatsapp',
        title: 'whatsapp',
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/8745080986", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/mritunjay-shall-peelam", "_blank");
        },
      },{
        id: 'social-youtube',
        title: 'YouTube',
        section: 'Socials',
        handler: () => {
          window.open("https://youtube.com/@msptutorial7884", "_blank");
        },
      },{
      id: 'light-theme',
